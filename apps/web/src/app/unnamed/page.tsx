...
function MappedList() {
  ...
  return (
    <div className="mt-12 space-y-4">
      {!mapped && <p className="text-white/45">Loading mapped submissions…</p>}
  ...
  return (
    <main className="mx-auto min-h-[100dvh] max-w-3xl px-6 pb-20 pt-28">
      ...
      {convexOk ? (
        ...
        <p className="mt-12 rounded-2xl border border-dashed border-white/15 p-8 text-white/50">
          Gallery appears once Convex cloud is linked to this deployment.
        </p>
      )}
    </main>
  );
